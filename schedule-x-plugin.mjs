class h {
   ...
   */
  constructor({ plugins: r = [], name: t = "scheduleXPluginManager" } = {}) {
  ...
  beforeRender(r) {
    this.plugins.forEach((t) => {
      var e;
      (e = t.beforeRender) === null || e === void 0 || e.call(t, r);
    });
  }
  /**
  ...
  onRender(r) {
    this.plugins.forEach((t) => {
      var e;
      (e = t.onRender) === null || e === void 0 || e.call(t, r);
    });
  }
}
class g {
